...
<head>
    ...
    <!-- Fonts -->
    <link href="{{ asset('assest/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
    ...
    <script src="{{ asset('assest/jquery-easing/jquery.easing.min.js') }}"></script>

    <!-- Custom scripts for all pages-->
    <script src="{{ asset('assest/js/sb-admin-2.min.js') }}"></script>

    <!-- Page level plugins -->
    <script src="{{ asset('assest/js/Chart.min.js') }}"></script>
